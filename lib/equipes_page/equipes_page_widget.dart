import '../add_equipe_page/add_equipe_page_widget.dart';
import '../auth/auth_util.dart';
import '../backend/backend.dart';
import '../competitions_page/competitions_page_widget.dart';
import '../eleves_page/eleves_page_widget.dart';
import '../equipe_detail_page/equipe_detail_page_widget.dart';
...
class EquipesPageWidget extends StatefulWidget {
  const EquipesPageWidget({Key? key}) : super(key: key);

  @override
  _EquipesPageWidgetState createState() => _EquipesPageWidgetState();
}

class _EquipesPageWidgetState extends State<EquipesPageWidget> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddEquipePageWidget(),
            ),
          );
        },
        backgroundColor: FlutterFlowTheme.of(context).primaryColor,
            ...
            children: [
              StreamBuilder<List<EquipesRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<EquipesRecord> listViewEquipesRecordList =
                      snapshot.data!;
                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: listViewEquipesRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewEquipesRecord =
                          listViewEquipesRecordList[listViewIndex];
                      return Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text(
                            listViewEquipesRecord.nom!,
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                          Text(
                            listViewEquipesRecord.tabnom!
                                .toList()
                                .length
                                .toString(),
                            style: FlutterFlowTheme.of(context).subtitle1,
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          EquipeDetailPageWidget(
                                        test1: listViewEquipesRecord.reference,
                                      ),
                                    ),
                                  );
                                },
