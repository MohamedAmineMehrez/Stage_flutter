...
class AddEquipePageWidget extends StatefulWidget {
  const AddEquipePageWidget({Key? key}) : super(key: key);

  @override
  _AddEquipePageWidgetState createState() => _AddEquipePageWidgetState();
}

class _AddEquipePageWidgetState extends State<AddEquipePageWidget> {
                    ...
                    builder: (context, snapshot) {
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          ...
                          await EquipesRecord.collection
                              .doc()
                              .set(equipesCreateData);
                          Navigator.pop(context);
                        },
                        text: 'Sauvgarder',
