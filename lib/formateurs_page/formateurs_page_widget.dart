import '../add_formateur_page/add_formateur_page_widget.dart';
...
import '../formateur_detail_page/formateur_detail_page_widget.dart';
...
class FormateursPageWidget extends StatefulWidget {
  const FormateursPageWidget({Key? key}) : super(key: key);

  @override
  _FormateursPageWidgetState createState() => _FormateursPageWidgetState();
}

class _FormateursPageWidgetState extends State<FormateursPageWidget> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddFormateurPageWidget(),
            ),
          );
        },
        backgroundColor: FlutterFlowTheme.of(context).primaryColor,
            ...
            children: [
              StreamBuilder<List<FormateursRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<FormateursRecord> listViewFormateursRecordList =
                      snapshot.data!;
                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: listViewFormateursRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewFormateursRecord =
                          listViewFormateursRecordList[listViewIndex];
                      return Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text(
                            listViewFormateursRecord.nom!,
                            style:
                          ...
                          Text(
                            listViewFormateursRecord.prenom!,
                            style:
                                FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily: 'Poppins',
                                      fontSize: 20,
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              await listViewFormateursRecord.reference.delete();
                            },
                          ),
                          StreamBuilder<List<FormateursRecord>>(
                            stream: queryFormateursRecord(),
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          FormateurDetailPageWidget(
                                        test1:
                                            listViewFormateursRecord.reference,
                                      ),
                                    ),
                                  );
                                },
