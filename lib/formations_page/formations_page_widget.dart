import '../add_formation_page/add_formation_page_widget.dart';
...
import '../formation_detail_page/formation_detail_page_widget.dart';
...
class FormationsPageWidget extends StatefulWidget {
  const FormationsPageWidget({Key? key}) : super(key: key);

  @override
  _FormationsPageWidgetState createState() => _FormationsPageWidgetState();
}
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddFormationPageWidget(),
            ),
          );
        },
        backgroundColor: FlutterFlowTheme.of(context).primaryColor,
            ...
            children: [
              StreamBuilder<List<FormationsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<FormationsRecord> listViewFormationsRecordList =
                      snapshot.data!;
                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: listViewFormationsRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewFormationsRecord =
                          listViewFormationsRecordList[listViewIndex];
                      return Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text(
                            listViewFormationsRecord.libelle!,
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                          Text(
                            listViewFormationsRecord.prix!.toString(),
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          FormationDetailPageWidget(
                                        test2:
                                            listViewFormationsRecord.reference,
                                      ),
                                    ),
                                  );
                                },
