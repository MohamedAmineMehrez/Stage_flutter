import '../add_competition_page/add_competition_page_widget.dart';
import '../auth/auth_util.dart';
import '../backend/backend.dart';
import '../competition_detail_page/competition_detail_page_widget.dart';
...
class CompetitionsPageWidget extends StatefulWidget {
  const CompetitionsPageWidget({Key? key}) : super(key: key);

  @override
  _CompetitionsPageWidgetState createState() => _CompetitionsPageWidgetState();
}
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddCompetitionPageWidget(),
            ),
          );
        },
        backgroundColor: FlutterFlowTheme.of(context).primaryColor,
            ...
            children: [
              StreamBuilder<List<CompetitionsRecord>>(
                stream: queryCompetitionsRecord(
                  queryBuilder: (competitionsRecord) =>
                      competitionsRecord.where('nom', isNotEqualTo: 'Null'),
                ),
                builder: (context, snapshot) {
                  ...
                  List<CompetitionsRecord> listViewCompetitionsRecordList =
                      snapshot.data!;
                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: listViewCompetitionsRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewCompetitionsRecord =
                          listViewCompetitionsRecordList[listViewIndex];
                      return Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text(
                            listViewCompetitionsRecord.nom!,
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                          Text(
                            dateTimeFormat(
                                'yMd', listViewCompetitionsRecord.dateCom!),
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          CompetitionDetailPageWidget(
                                        com: listViewCompetitionsRecord
                                            .reference,
                                      ),
                                    ),
                                  );
