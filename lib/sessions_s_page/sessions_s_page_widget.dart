import '../add_session_s_page/add_session_s_page_widget.dart';
...
import '../session_s_detail_page/session_s_detail_page_widget.dart';
import '../sessions_page/sessions_page_widget.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';

class SessionsSPageWidget extends StatefulWidget {
  const SessionsSPageWidget({Key? key}) : super(key: key);

  @override
  _SessionsSPageWidgetState createState() => _SessionsSPageWidgetState();
}

class _SessionsSPageWidgetState extends State<SessionsSPageWidget> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddSessionSPageWidget(),
            ),
          );
        },
        backgroundColor: FlutterFlowTheme.of(context).primaryColor,
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, listViewIndex) {
                      ...
                      return Row(
                        ...
                        children: [
                          Text(
                            listViewSessionSRecord.libelle!,
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                          Text(
                            listViewSessionSRecord.prix!.toString(),
                            style: FlutterFlowTheme.of(context).subtitle1,
                          ),
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          SessionSDetailPageWidget(
                                        test3: listViewSessionSRecord.reference,
                                      ),
                                    ),
                                  );
                                },
