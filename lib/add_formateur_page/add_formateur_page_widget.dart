...
class AddFormateurPageWidget extends StatefulWidget {
  const AddFormateurPageWidget({Key? key}) : super(key: key);

  @override
  _AddFormateurPageWidgetState createState() => _AddFormateurPageWidgetState();
}

class _AddFormateurPageWidgetState extends State<AddFormateurPageWidget> {
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await FormateursRecord.collection
                          .doc()
                          .set(formateursCreateData);
                      Navigator.pop(context);
                    },
                    text: 'Sauvgarder',
