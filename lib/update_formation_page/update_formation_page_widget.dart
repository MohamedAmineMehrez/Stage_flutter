...
class UpdateFormationPageWidget extends StatefulWidget {
  const UpdateFormationPageWidget({
    Key? key,
    this.test2,
  }) : super(key: key);
  ...
  @override
  _UpdateFormationPageWidgetState createState() =>
      _UpdateFormationPageWidgetState();
}

class _UpdateFormationPageWidgetState extends State<UpdateFormationPageWidget> {
            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<FormationsRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final libelleFormationsRecord = snapshot.data!;
                    return TextFormField(
                      controller: libelleController ??= TextEditingController(
                        text: libelleFormationsRecord.libelle,
                      ),
                      obscureText: false,
              ...
              Row(
                ...
                children: [
                  ...
                  StreamBuilder<FormationsRecord>(
                    stream: FormationsRecord.getDocument(widget.test2!),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                      ...
                      final iconButtonFormationsRecord = snapshot.data!;
                      return FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          await DatePicker.showDatePicker(
                            ...
                            currentTime: iconButtonFormationsRecord.dateD!,
              ...
              Padding(
                ...
                child: StreamBuilder<FormationsRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final prixFormationsRecord = snapshot.data!;
                    return TextFormField(
                      controller: prixController ??= TextEditingController(
                        text: prixFormationsRecord.prix?.toString(),
                      ),
                      obscureText: false,
                      decoration: InputDecoration(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          ...
                          await widget.test2!.update(formationsUpdateData);
                          await showDialog(
                            context: context,
