...
class UpdateSessionPageWidget extends StatefulWidget {
  const UpdateSessionPageWidget({
    Key? key,
    this.sessionb,
  }) : super(key: key);

  final DocumentReference? sessionb;

  @override
  _UpdateSessionPageWidgetState createState() =>
      _UpdateSessionPageWidgetState();
}

class _UpdateSessionPageWidgetState extends State<UpdateSessionPageWidget> {
  DateTime? datePicked;
              ...
              Row(
                ...
                children: [
                  ...
                  StreamBuilder<SessionsRecord>(
                    stream: SessionsRecord.getDocument(widget.sessionb!),
                    ...
                    builder: (context, snapshot) {
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          ...
                          await widget.sessionb!.update(sessionsUpdateData);
                          await showDialog(
                            context: context,
